                ...
                <div className="row align-items-center">
                  <div className="col col-lg-6">
                    ...
                    <p className="page_description">
                      Contactez-nous pour toute question, suggestion ou demande d'assistance. Notre équipe est là pour vous
                      aider à renforcer vos compétences en sécurité web
                    </p>
                  </div>
                </div>
              </div>
                        ...
                        <div className="col">
                          <div className="section_heading text-center">
                            <h2 className="heading_text mb-0">
                              Contactez notre équipe d'assistance pour savoir ce que vous voulez
                            </h2>
                          </div>
                        </div>
                      </div>
                            ...
                            <div className="row">
                              <div className="col col-md-6">
                                <div className="form_item m-0">
                                  ...
                                  <input id="input_name" type="text" name="name" placeholder="Votre Name" />
                                </div>
                              </div>
                              <div className="col col-md-6">
                                <div className="form_item m-0">
                                  <label htmlFor="input_email" className="input_title">Email</label>
                                  <input id="input_email" type="email" name="email" placeholder="Votre Email" />
                                </div>
                              </div>
                              <div className="col col-md-6">
                                <div className="form_item m-0">
                                  <label htmlFor="input_phone" className="input_title">Téléphone</label>
                                  <input id="input_phone" type="tel" name="telephone" placeholder="Votre Numéro" />
                                </div>
                              </div>
                              <div className="col col-md-6">
                                <div className="form_item m-0">
                                  <label htmlFor="input_jubject" className="input_title">Sujet</label>
                                  <select name="subject" id="input_jubject">
                                    <option value="subject" selected>Choisir le sujet</option>
                                    <option value="volvo">Probleme de cours</option>
                                    <option value="saab">Probleme d'inscription</option>
                                    <option value="mercedes">Question sur zero2hero</option>
                              ...
                              <div className="col">
                                <div className="form_item">
                                  ...
                                  <textarea id="input_message" name="message" placeholder="Tapez votre message..." defaultValue={""} />
                                </div>
